...
class Librarian(User):
    id = db.Column(db.Integer, db.ForeignKey('user.id', ondelete='CASCADE'), primary_key=True)
    current_residence = db.Column(db.String(64), default='Roselyn, Nairobi')
    department = db.Column(db.String(64), default='Library')
    salary = db.Column(db.Integer)
    ...
    def __repr__(self):
        return f'Librarian: {self.first_name} | {self.department}'


class Cook(User):
    id = db.Column(db.Integer, db.ForeignKey('user.id', ondelete='CASCADE'), primary_key=True)
    current_residence = db.Column(db.String(64), default='Roselyn, Nairobi')
    department = db.Column(db.String(64), default='Kitchen')
    salary = db.Column(db.Integer)
    ...
    def __repr__(self):
        return f'Cook: {self.first_name} | {self.department}'
